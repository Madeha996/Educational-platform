...
export const sidebarNavigation: SidebarNavigationItem[] = [
  ...
  {
    title: 'common.university-managment',
    key: 'university-managment',
    url: '/university-managment',
    icon: <NftIcon />,
  },
  {
    title: 'common.majority-managment',
    key: 'majority-managment',
    url: '/majority-managment',
    icon: <NftIcon />,
  },
  {
    title: 'common.years-managment',
    key: 'years-managment',
    url: '/years-managment',
    icon: <NftIcon />,
  },
  {
    title: 'common.sessions-managment',
    key: 'sessions-managment',
    url: '/sessions-managment',
    icon: <NftIcon />,
  },
  {
    title: 'common.subjects-managment',
    key: 'subjects-managment',
    url: '/subjects-managment',
    icon: <NftIcon />,
  },
  {
    title: 'common.files-managment',
    key: 'files-managment',
    url: '/files-managment',
    icon: <NftIcon />,
  },
